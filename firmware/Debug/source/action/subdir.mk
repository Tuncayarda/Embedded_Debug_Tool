...
C_DEPS += \
./source/action/action.d 

OBJS += \
./source/action/action.o 


# Each subdirectory must supply rules for building sources it contributes
source/action/%.o: ../source/action/%.c source/action/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-action

clean-source-2f-action:
	-$(RM) ./source/action/action.d ./source/action/action.o

.PHONY: clean-source-2f-action
